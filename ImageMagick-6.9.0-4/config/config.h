...
#define LIBRARY_PATH "/usr/local/lib/ImageMagick-6.9.0/"

/* Subdirectory of lib where ImageMagick architecture dependent files are
   installed */
#define LIBRARY_RELATIVE_PATH "ImageMagick-6.9.0"
...
/* Target Host OS */
#define MAGICK_TARGET_OS darwin13.4.0
...
#define PACKAGE_STRING "ImageMagick 6.9.0-4"
...
#define PACKAGE_VERSION "6.9.0-4"
